...
#ifndef CONFIG_LGE_DISPLAY_NO_PANEL_TYPE
extern char mtkfb_lcm_name[]; /* mtkfb.c */
static ssize_t show_panel_type(struct device *device,
			 struct device_attribute *attr, char *buf)
{
#if defined(TARGET_MT6735_M1V) || defined(TARGET_MT6735_M4) || defined(TARGET_MT6735_K6)
