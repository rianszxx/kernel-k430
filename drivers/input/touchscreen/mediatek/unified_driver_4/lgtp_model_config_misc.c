...
void TouchGetModelConfig(TouchDriverData *pDriverData)
{
	...
	#if defined(TOUCH_MODEL_C70) || defined(TOUCH_MODEL_Y70) || defined(TOUCH_MODEL_LION_3G) || defined ( TOUCH_MODEL_P1C) || defined (TOUCH_MODEL_M1V) || defined (TOUCH_MODEL_M4)
...
void TouchVddPowerModel(int isOn)
{
	...
	#elif defined(TOUCH_MODEL_LION_3G) || defined ( TOUCH_MODEL_P1C) || defined (TOUCH_MODEL_M1V) || defined (TOUCH_MODEL_M4)
