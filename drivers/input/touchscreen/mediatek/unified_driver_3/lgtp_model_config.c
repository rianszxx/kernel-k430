...
struct of_device_id  s3320_MatchTable[2] = {{ .compatible = "unified_driver_ver3,s3320", },};
#endif
...
void TouchGetModelConfig(TouchDriverData *pDriverData)
{
	...
	pConfig->protocol_type = MT_PROTOCOL_B;
		...
		|| defined(TOUCH_MODEL_YG) || defined(TOUCH_MODEL_C100N) || defined(TOUCH_MODEL_K7)
