...
{0x29, 0XB4,  6,  {0x05, 0x04, 0x1F, 0x68, 0x11, 0x00}}, //Channel Control
...
{0x15, 0xCF,  1,  {0x0E}}, // Touch Control Set
{0x29, 0XC6,  2,  {0x0A, 0x00}},    //Bias control
{0x29, 0xD7, 26,  {0x00, 0x13, 0xFF, 0x39, 0x0B, 0x04, 0x14, 0xF4, 0x01, 0x00, 0x00, 0x00, 0x00, 0x40, 0x01, 0x4F,
             0x4F, 0x29, 0x20, 0x20, 0x4A, 0x00, 0x00, 0x00, 0x00, 0x00}}, //Touch GIP control
...
{0x29, 0xD0,  9,  {0x30, 0x26, 0x72, 0x13, 0x02, 0x02, 0x43, 0x23, 0x02}}, //Gamma
{0x29, 0xD1,  9,  {0x30, 0x26, 0x72, 0x13, 0x00, 0x02, 0x43, 0x23, 0x02}},
{0x29, 0xD2,  9,  {0x30, 0x26, 0x72, 0x13, 0x02, 0x02, 0x43, 0x23, 0x02}},
{0x29, 0xD3,  9,  {0x30, 0x26, 0x72, 0x13, 0x00, 0x02, 0x43, 0x23, 0x02}},
{0x29, 0xD4,  9,  {0x30, 0x26, 0x72, 0x13, 0x02, 0x02, 0x43, 0x23, 0x02}},
{0x29, 0xD5,  9,  {0x30, 0x26, 0x72, 0x13, 0x00, 0x02, 0x43, 0x23, 0x02}},
{0x29, 0xD0,  4,  {0x30, 0x26, 0x72, 0x13}}, //Gamma
{0x29, 0xD1,  4,  {0x30, 0x26, 0x72, 0x13}},
{0x29, 0xD2,  4,  {0x30, 0x26, 0x72, 0x13}},
{0x29, 0xD3,  4,  {0x30, 0x26, 0x72, 0x13}},
{0x29, 0xD4,  4,  {0x30, 0x26, 0x72, 0x13}},
{0x29, 0xD5,  4,  {0x30, 0x26, 0x72, 0x13}},
{0x05, 0x11,  1,  {0x00}},
{REGFLAG_END_OF_TABLE, 0x00, 1,{}},
#endif
};
...
static void lcm_get_params(LCM_PARAMS * params)
{
    ...
    params->dsi.vertical_frontporch = 287;
    params->dsi.vertical_active_line = FRAME_HEIGHT;
    ...
    params->dsi.PLL_CLOCK = 270; //312; // 234;
#endif
...
// ---------------------------------------------------------------------------
LCM_DRIVER lg4894_hd720_dsi_vdo_lgd_drv = {
    .name = "lg4894_hd720_dsi_vdo_lgd",
