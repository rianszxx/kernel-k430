...
#include "mn34153mipiraw_Sensor.h"

#define PFX "MN34153_camera_sensor"
...
static imgsensor_info_struct imgsensor_info = { 
	...
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gb,      //popo SENSOR_OUTPUT_FORMAT_RAW_Gr--->SENSOR_OUTPUT_FORMAT_RAW_Gb
	.mclk = 24,
...
static imgsensor_struct imgsensor = {
    .mirror = IMAGE_HV_MIRROR,                //mirrorflip information  //popo
...
{
	LOG_INF("MN34153_Sensor_Init enter :\n ");
...
//	write_cmos_sensor(0x33E3,0x7E);
	...
	LOG_INF("MN34153_Sensor_Init exit :\n ");
}   /*  MN34153_Sensor_Init  */	/*	sensor_init  */

static void preview_setting(void)
{
	LOG_INF("MN34153PreviewSetting_4lane_30fps enter :\n ");
...
//	write_cmos_sensor(0x3077,0x00);
	...
	LOG_INF("MN34153PreviewSetting exit :\n ");
}   /*  preview_setting  */
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	preview_setting();
    set_mirror_flip(IMAGE_HV_MIRROR); //popo
