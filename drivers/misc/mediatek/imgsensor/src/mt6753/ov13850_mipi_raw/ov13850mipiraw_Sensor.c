...
//popo #define LOG_INF(format, args...)    xlog_printk(ANDROID_LOG_INFO   , PFX, "[%s] " format, __FUNCTION__, ##args)
...
#if defined(TARGET_MT6753_M4)	//[LGE_UPDATE_S][kipo.yun@lge.com][2015-12-21] Delete 0x6c
...
static imgsensor_struct imgsensor = {
    .mirror = IMAGE_V_MIRROR,                //mirrorflip information  //popo
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    spin_unlock(&imgsensor_drv_lock);
    preview_setting();
    set_mirror_flip(IMAGE_V_MIRROR); //popo
