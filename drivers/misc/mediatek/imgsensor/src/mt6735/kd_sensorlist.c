...
static int CAMERA_HW_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	/* set I2C clock rate */
	g_pstI2Cclient->timing = 400;/* 400k */ //LGE_CHANGE: [2015-12-08] yonghwan.lym@lge.com, Modify the I2C Spped 100k -> 400k
...
static int CAMERA_HW_i2c_probe2(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	/* set I2C clock rate */
	g_pstI2Cclient2->timing = 400;/* 400k */ //LGE_CHANGE: [2015-12-08] yonghwan.lym@lge.com, Modify the I2C Spped 100k -> 400k
...
static int CAMERA_HW_probe(struct platform_device *pdev)
{
	...
	mtkcam_flash_gpio_init(pdev); //LGE_CHANGE : [2015-10-19] yonghwan.lym@lge.com, Flash Enable
#endif
