...
static struct i2c_board_info __initdata i2c_lsm6ds3={ I2C_BOARD_INFO(LSM6DS3_ACC_DEV_NAME, 0x6B)};
...
{
	.i2c_num = 3,
	.direction = 5, // 5, // 3, // 2, // 1, //0, // 6, // 7, // wanghe 2013-01-03 v10 is different!!
...
static int LSM6DS3_ReadAccData(struct i2c_client *client, char *buf, int bufsize)
{
	...
	{
	#if 1
		obj->data[LSM6DS3_AXIS_X] = (long)(obj->data[LSM6DS3_AXIS_X]) * obj->sensitivity/1000; //NTC
		obj->data[LSM6DS3_AXIS_Y] = (long)(obj->data[LSM6DS3_AXIS_Y]) * obj->sensitivity/1000 ;
		obj->data[LSM6DS3_AXIS_Z] = (long)(obj->data[LSM6DS3_AXIS_Z]) * obj->sensitivity/1000;
		...
		acc[LSM6DS3_AXIS_X] = acc[LSM6DS3_AXIS_X] * GRAVITY_EARTH_1000 /1000 ;
		acc[LSM6DS3_AXIS_Y] = acc[LSM6DS3_AXIS_Y] * GRAVITY_EARTH_1000 /1000;
		acc[LSM6DS3_AXIS_Z] = acc[LSM6DS3_AXIS_Z] * GRAVITY_EARTH_1000 /1000;		
...
static int lsm6ds3_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	if(err)
	{
		GSE_ERR("lsm6ds3_init_client failed!\n");
...
static int lsm6ds3_i2c_remove(struct i2c_client *client)
{
	...
	{
		GSE_ERR("lsm6ds3_i2c init flag -1\n");
...
{
	//GSE_FUN();
	struct acc_hw *hw = get_cust_accel();
