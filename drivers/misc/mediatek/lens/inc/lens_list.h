...
extern void DW9719TAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
...
// LGE_CHANGE_S: [2015-10-07] yonghwan.lym@lge.com, VCM(DW9719) BringUp
...
#endif
// LGE_CHANGE_E: [2015-10-07] yonghwan.lym@lge.com, VCM(DW9719) BringUp

// LGE_CHANGE_S: [2015-10-30] kipo.yun@lge.com, VCM(ZC533) BringUp
...
#endif
// LGE_CHANGE_E: [2015-10-30] kipo.yun@lge.com, VCM(ZC533) BringUp
