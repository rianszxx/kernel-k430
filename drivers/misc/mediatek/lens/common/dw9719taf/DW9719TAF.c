...
#endif
//LGE_CHANGE_S: [2015-12-08] yonghwan.lym@lge.com, Code for AF de-noise during the camera enter
	char puSendCmdArray[7][2] = {
        ...
        {0xFE, 0xFE}, // delay
        {0x02, 0x02}, // SAC3 mode
        {0x06, 0x40}, // Tvib 9.5ms
        {0x07, 0x60}  // Tvib 9.5ms
	};
//LGE_CHANGE_E: [2015-12-08] yonghwan.lym@lge.com, Code for AF de-noise during the camera enter
	...
	for (cmd_number = 0; cmd_number < 7; cmd_number++) { //LGE_CHANGE: [2015-12-08] yonghwan.lym@lge.com, Code for AF de-noise during the camera enter
