...
/* LGE CHANGE_S 2015-09-07 max.chung@lge.com register earjack to input device */
#define SW_HEADPHONE_INSERT 0x02
#define SW_MICROPHONE_INSERT 0x04
/* LGE CHANGE_E 2015-09-07 max.chung@lge.com register earjack to input device */
...
/* [LGE_BSP_COMMON] CHANGE_S 2015-12-09 Max.chung@lge.com fixed error when 3-pole headset is inserted*/
static int button_press_debounce = 0x800;
/* [LGE_BSP_COMMON] CHANGE_E 2015-12-09 Max.chung@lge.com fixed error when 3-pole headset is inserted*/
int cur_key = 0;
...
/* [LGE_BSP_COMMON] CHANGE_S 2015-09-07 Max.chung@lge.com for 16ohm earphone*/
static bool is_ready_to_detect_jack_type = 0;
/* [LGE_BSP_COMMON] CHANGE_E 2015-09-07 Max.chung@lge.com for 16ohm earphone*/
...
{
/* LGE CHANGE_S 2014-09-07 max.chung@lge.com register earjack to input device */
...
/* LGE CHANGE_E 2014-09-07 max.chung@lge.com register earjack to input device */
	accdet_status = PLUG_OUT;
	cable_type = NO_DEVICE;
...
#define PIN_ADC_CHANNEL 5
	...
	/* [LGE_BSP_COMMON] CHANGE_S 2015-10-12 Max.chung@lge.com for 16ohm earphone*/
	if ( cable_type== NO_DEVICE )
	{
		is_ready_to_detect_jack_type = 1;
		ACCDET_DEBUG("[Accdet]Now ready to detect headset type\n");
	}
        /* [LGE_BSP_COMMON] CHANGE_E 2015-10-12 Max.chung@lge.com for 16ohm earphone*/
