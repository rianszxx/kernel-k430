...
#if defined(TARGET_MT6582_Y70) || defined(TARGET_MT6582_Y90) || defined(TARGET_MT6753_K7) || defined(TARGET_MT6582_B2L) || defined(TARGET_MT6582_P1S3G) /* LGE_BSP_COMMON sangcheol.seo@lge.com 140520 : Porting */
extern int mt_mt65xx_breath_mode(unsigned int patternid);
