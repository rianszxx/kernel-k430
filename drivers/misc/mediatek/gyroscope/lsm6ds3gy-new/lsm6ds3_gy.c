...
static int LSM6DS3_ReadGyroData(struct i2c_client *client, char *buf, int bufsize)
{
	...
	#endif
			/*report degree/s */
		obj->data[LSM6DS3_AXIS_X] = (long)(obj->data[LSM6DS3_AXIS_X])*(LSM6DS3_GYRO_SENSITIVITY_2000DPS/1000);
		obj->data[LSM6DS3_AXIS_Y] = (long)(obj->data[LSM6DS3_AXIS_Y])*(LSM6DS3_GYRO_SENSITIVITY_2000DPS/1000);
		obj->data[LSM6DS3_AXIS_Z] = (long)(obj->data[LSM6DS3_AXIS_Z])*(LSM6DS3_GYRO_SENSITIVITY_2000DPS/1000); 
