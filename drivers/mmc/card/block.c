...
static int mmc_blk_probe(struct mmc_card *card)
{
	...
	/* TD130874
	 * DESC: When installing removable sd card warning occured twice.
	 * Cause: Minor number is changed 
	 * 		  because the previous minor number wasn't released.
	 * Fixed: Added msleep(500) on the mmc_blk_probe()
	 */
